...
plan_preference = simpledialog.askstring("Plan Pereference", "Type 'Y' if you prefer to have a lighter exercise plan / Type 'N' if you prefer to have a more flexible meal plan",
                                parent=ws)
if plan_preference == 'Y':
    ...
    print('Your daily calories burned through exercising will be {:.0f} cal'.format(exercise_calories))
...
#imports meal plan recommendation from recomm
from recomm_plan import recomm

#imports exercise plan recommendation from recomm
...
if show_direc == 'Y':
    ...
    print(df_2) 
    df_2.to_csv('cooking_direction.csv')
